...
* matplotlibで日本語が表示されなかったので、フォントを追加した(MBP)
	* [参考記事](https://qiita.com/knknkn1162/items/be87cba14e38e2c0f656)
...
* 多次元の可視化にはt-SNEが人気
* 終わり）1.GBDTの動作確認する
* 終わり）サンプルプログラムの命名規則整理する
* 終わり）サンプルデータセットの中身を確認する
...
* 今更だけど多次元の線形分離ってどうやっているんだろうか
　2次元、3次元の分離ならわかるけど、なぜ多次元でも線形分離できるのか
